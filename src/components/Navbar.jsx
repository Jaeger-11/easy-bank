...
const Navbar = () => {
    ...
    return (
    <div className='bg-white sticky z-10 top-0 py-5 px-4 md:p-4'>
        <nav className="flex justify-between items-center md:mx-auto md:w-4/5">
            ...
            {
                isMenu &&
                <ul className="absolute shadow-2xl top-[70px] left-[50%] translate-x-[-50%] bg-white w-[90%] py-8 rounded-md text-center text-base flex-col md:relative md:top-0 flex md:flex-row gap-4 lg:gap-6 text-grayishBlue">
